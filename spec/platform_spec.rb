...
describe Phantomjs::Platform do
  ...
  describe "on FreeBSD" do
    before do
      Phantomjs::Platform.stub(:host_os).and_return =~ "freebsd"
      Phantomjs::Platform.stub(:architecture).and_return('x86_64')
    end

    it "reports the FreeBSD Platform as useable" do
      Phantomjs::Platform::FreeBSD.should be_useable
    end
    ...
    it "reports the FreeBSD platform as unuseable" do
      Phantomjs::Platform::FreeBSD.should_not be_useable
    end
