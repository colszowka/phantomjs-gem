  ...
  class Platform
    ...
    class Linux64 < Platform
      class << self
        ...
        def package_url
          'https://bitbucket.org/ariya/phantomjs/downloads/phantomjs-1.9.9-linux-x86_64.tar.bz2'
        end
      end
    end
    ...
    class Linux32 < Platform
      class << self
        ...
        def package_url
          'https://bitbucket.org/ariya/phantomjs/downloads/phantomjs-1.9.9-linux-i686.tar.bz2'
        end
      end
    end
    ...
    class OsX < Platform
      class << self
        ...
        def package_url
          'https://bitbucket.org/ariya/phantomjs/downloads/phantomjs-1.9.9-macosx.zip'
        end
      end
    end
